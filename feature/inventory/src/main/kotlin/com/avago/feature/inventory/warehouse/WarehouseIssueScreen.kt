...
@Composable
fun WarehouseIssueScreen(
    onBack: () -> Unit,
    viewModel: WarehouseIssueViewModel = hiltViewModel(),
) {
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text(stringResource(R.string.warehouse_issue_title)) },
                navigationIcon = {
        ...
        Column(
            ...
            OutlinedTextField(
                ...
                onValueChange = viewModel::setWorkOrderId,
                label = { Text(stringResource(R.string.warehouse_wo_label)) },
                modifier = Modifier.fillMaxWidth(),
                singleLine = true,
            )
